...
import { StyledCardHeader, StyledDoctorDiv, StyledDoctorPaper, StyledFavoriteIcon, StyledHospitalIcon, StyledOpacFavoriteIcon, StyledProfileButton } from "../StyledComponents/Styled";
    const profile = [
        {pic:'doctorSarah.jpg',name:'Sarah Smith M.D.',body:'Doctor Sarah Smith is a Harvard Medical graduate with over 20 years of Pulmonology experience. She completed his fellowship at UCLA and has been the lead for the pulmonology unit for 5 years.'},
        ...
        {pic:'doctorDan.webp',name:'Dave Matthews M.D.',body:'Doctor Dave Matthews is a Cambridge University graduate with a speciality in neurology. He has made strides in his field with his research on neuropathy treatments.'},
    ]   
const DoctorProfile = () => {
  return (
    <StyledDoctorDiv>
